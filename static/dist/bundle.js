...
var _google = __webpack_require__(135);

var _google2 = _interopRequireDefault(_google);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_google2.default.charts.load('current', { 'packages': ['timeline'] });
_google2.default.charts.setOnLoadCallback(init);

var data_container = $("#user-data");
data_container.hide();
var date_picker = void 0;

var user_container = $("#search-results");
var users = [];
var active_user = null;

var last_chart = null;
var chart_container = document.getElementById('activity-chart-container');
...
function activity_data_cb(user, data, start, end) {
    var chart = new _google2.default.visualization.Timeline(chart_container);
    ...
    var last = { timestamp: start.toDate(), status: -999 };
    ...
    try {
        for (var _iterator2 = data[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            var lat = _step2.value;

            if (start == null) {
                start = lat;
            } else {
                if (lat.status != last.status) {
                    var status = status_name(last.status);
    ...
    if (rows.length > 0) {
        var dataTable = new _google2.default.visualization.DataTable();
...
function update_activity(start, end) {
    ...
    if (active_user) {
        var activity = [];
        fetch('/data/activity/' + active_user.userid + '/' + start.unix() * 1000 + '/' + end.unix() * 1000).then(function (res) {
            return res.json();
        }).then(function (j) {
            activity = j;
...
function init() {
    ...
    fetch('/data/users').then(function (res) {
        return res.json();
    }).then(function (j) {
        users = j;
    ...
    $("#search-input").on('input', function (e) {
        ...
        var results = users.filter(function (elem, index, arr) {
